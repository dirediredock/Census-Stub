...
plt.savefig("DS_01.png", format="png", dpi=800)
plt.close()
...
plt.savefig("DS_03.png", format="png", dpi=800)
plt.close()
...
plt.savefig("DS_05.png", format="png", dpi=800)
plt.close()
...
plt.savefig("DS_04.png", format="png", dpi=800)
plt.close()
...
plt.savefig("DS_02.png", format="png", dpi=800)
plt.close()
